    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            if choice == 1:
                ...
                output_message += "ID Proof : " + customer_database.__next__().replace("\n", "") + "\n"
            else:
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        p1 = PhotoImage(file = "images\saitama.png")
        window.iconphoto(True, p1)
        window.configure(background="#28a686")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#38e0b6", borderwidth="0", insertbackground="black",
                                 relief="ridge",
...
class Error:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file="images\saitama.png")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#6882a3")
        ...
        self.Label1 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 14 -weight bold", 
                                foreground="#00254a", text="Admin Login")
        ...
        self.Entry1 = tk.Entry(Canvas1, background="#03cafc", borderwidth="2", disabledforeground="#a3a3a3",
        ...
        self.Entry1_1 = tk.Entry(Canvas1, show='*', background="#03cafc", borderwidth="2",
        ...
        self.Label5 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 14 -weight bold", 
                                foreground="#00254a", text="ID")
        self.Label5.place(relx=0.350, rely=0.420, height=41, width=154)

        self.Label6 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 14 -weight bold", 
                                foreground="#00254a", text="Password")
        self.Label6.place(relx=0.350, rely=0.577, height=41, width=154)
        ...
        global admin_img
        admin_img = tk.PhotoImage(file="images\saitama.png")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        window.configure(background="#00632d")
        ...
        self.Label6 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 14 -weight bold", 
                                foreground="#00254a", text="ID")
        self.Label6.place(relx=0.350, rely=0.420, height=41, width=154)

        self.Label7 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 14 -weight bold", 
                                foreground="#00254a", text="Password")
        self.Label7.place(relx=0.350, rely=0.577, height=41, width=154)
        ...
        global customer_img
        customer_img = tk.PhotoImage(file="images\saitama.png")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#490091")
                            ...
                            if gender == "Male" or gender == "Female":
                                if nationality.__len__() != 0:
                                    if ID_proof.__len__() != 0:
                                        ...
                                        Error(Toplevel(self.master))
                                        Error.setMessage(self, message_shown="Enter ID proof!")
                                        return
                                else:
                                    Error(Toplevel(self.master))
